...
const handleSearch = ()=>{
  ...
  { type !== "list" &&
    ...
    .Unlock instant savings with 10% and more with a free booking account.
    </p>
...
<button disabled={options.room <=1}  className='optionCounterButton' onClick={()=>handleOption("room","d")}>-</button></div>
</div>
</div>}
